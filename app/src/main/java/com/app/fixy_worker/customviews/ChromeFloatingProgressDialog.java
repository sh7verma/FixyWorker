...
public class ChromeFloatingProgressDialog extends Drawable implements Drawable.Callback {
    ...
    public ChromeFloatingProgressDialog(int[] colors) {
    ...
    public static class Builder {
        ...
        public Drawable build() {
            return new ChromeFloatingProgressDialog(mColors);
        }
    }
}